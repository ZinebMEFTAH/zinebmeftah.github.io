...
const translations = {
    fr: {
      ...
      "stat.rank": "Major de promotion L2 & L3", "stat.avg": "Moyenne générale · licence", "stat.english": "Anglais · LanguageCert (Ofqual)", "stat.prod": "Systèmes IA @ GE HealthCare",
      ...
      "profile.text1": "Major de promotion en L2 et L3 à l’Université d’Avignon (1ʳᵉ sur 126, moyenne générale 15,18/20), issue du cycle préparatoire d’élite de l’ENSIA à Alger. Ingénieure IA et MLOps, je conçois des agents RAG, des pipelines LLM et des systèmes autonomes, et je les emmène jusqu’à la production.",
      ...
      "formation.avignon.desc": "<strong>Licence Informatique — Parcours IA :</strong> Major de promotion L2 & L3 (1ʳᵉ sur 126), moyenne générale 15,18/20.",
      ...
      "formation.bac.desc": "<strong>Mention :</strong> Très bien — Moyenne 17,82/20",
    ...
    en: {
      ...
      "stat.rank": "Top of class · L2 & L3", "stat.avg": "Overall average · BSc", "stat.english": "English · LanguageCert (Ofqual)", "stat.prod": "AI systems @ GE HealthCare",
      "badge.production": "Production",
      ...
      "profile.text1": "Top of my class in both L2 and L3 at the University of Avignon (1st of 126, overall average 15.18/20), after an elite preparatory programme at ENSIA in Algiers. As an AI and MLOps engineer I build RAG agents, LLM pipelines and autonomous systems, and I take them all the way to production.",
      ...
      "formation.avignon.desc": "<strong>BSc Computer Science — AI track:</strong> Ranked 1st in L2 & L3 (1st of 126), overall average 15.18/20.",
      ...
      "formation.bac.desc": "<strong>Honours:</strong> Très bien (with high honours) — Average 17.82/20",
    ...
    ar: {
      ...
      "profile.text1": "الأولى على دفعتها في السنتين الثانية والثالثة بجامعة أفينيون (1 من 126، بمعدّل عام 15.18 من 20)، بعد طور تحضيري نخبوي بمدرسة ENSIA في الجزائر. مهندسة ذكاء اصطناعي وMLOps، أُصمّم وكلاء RAG وخطوط معالجة LLM وأنظمة مستقلة، وأرافقها حتى الإنتاج.",
      ...
      "formation.avignon.desc": "<strong>إجازة في الإعلام الآلي — تخصص الذكاء الاصطناعي:</strong> الأولى على الدفعة في السنتين الثانية والثالثة (1 من 126)، بمعدّل عام 15.18 من 20.",
      "formation.bac.title": "بكالوريا علمية",
      "formation.bac.desc": "<strong>التقدير:</strong> جيد جدًا — معدل 17.82 من 20",
